...
'''
fit params of the weibull distribution
'''

#stats.weibull_max.fit(cost_list, floc=0, f0=1)
#shape, loc, scale = stats.weibull_max.fit(cost_list)
(loc, scale) = stats.exponweib.fit_loc_scale(cost_list, 1, 1)
def weib(x,n,a):
